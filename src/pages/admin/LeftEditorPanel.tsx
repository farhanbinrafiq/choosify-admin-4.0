    ...
    <div className="flex-1 flex flex-col space-y-4">
      ...
      <div id="editor-section-identity" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "identity" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
            ...
            <div className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#F5F5F5] border border-gray-200 px-3 py-2 rounded-lg text-[12px] font-bold text-[#111827] focus:outline-none focus:border-[#EF3C23]"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button onClick={addCategoryTag} className="px-3 bg-[#EF3C23] text-white rounded-lg font-bold text-xs">Add</button>
                </div>
      ...
      <div id="editor-section-trust" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "trust" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
      ...
      <div id="editor-section-products" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "products" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
          ...
          <div className="p-5 border-t border-gray-100 bg-white space-y-4 text-[12px] text-[#111827]">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-[#EA6C0A] hover:bg-[#EF3C23] text-white rounded-lg text-xs font-bold flex items-center gap-1"
              >
                        ...
                        <td className="p-2 text-center">
                          <button
                            ...
                            className={`p-1.5 rounded-md ${
                              p.featured 
                                ? "bg-amber-100 text-[#EF3C23] border border-amber-200" 
      ...
      <div id="editor-section-deals" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "deals" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-2 py-1 bg-[#EA6C0A] hover:bg-[#EF3C23] text-white rounded text-[10px] font-bold flex items-center gap-1"
                >
      ...
      <div id="editor-section-creator" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "creator" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
      ...
      <div id="editor-section-reviews" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "reviews" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
              <Star className="w-4 h-4 text-[#EF3C23]" />
            </span>
            <div>
      ...
      <div id="editor-section-team" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "team" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
              <Users2 className="w-4 h-4 text-[#EF3C23]" />
            </span>
            <div>
                    ...
                    <tr key={tm.id} className="hover:bg-gray-50/50">
                      ...
                      <td className="p-1.5 text-right">
                        <div className="flex gap-1 justify-end">
                          {tm.role !== "Owner" && (
                            <>
                              <button onClick={() => toggleSuspendTeam(tm.id)} className="px-1.5 py-0.5 bg-gray-100 text-slate-700 hover:bg-[#EF3C23] hover:text-white rounded text-[9px] font-bold">
      ...
      <div id="editor-section-info" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "info" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
      ...
      <div id="editor-section-visibility" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm transition-all">
        <button
          ...
          className={`w-full px-5 py-4 border-l-4 flex items-center justify-between text-left transition-colors ${
            activeSection === "visibility" ? "border-[#EF3C23] bg-orange-50/10" : "border-transparent bg-white hover:bg-gray-50"
          }`}
        >
          <div className="flex items-center gap-3">
            <span className="p-1.5 bg-orange-50 text-[#EF3C23] rounded-md">
              <Eye className="w-4 h-4 text-[#EF3C23]" />
            </span>
            <div>
              ...
              {[
                ...
                <label key={k} className="flex items-center gap-2.5 py-1 text-[12px] font-bold text-gray-700 cursor-pointer hover:text-[#111827] select-none">
                  <input
                    ...
                    className="accent-[#EF3C23] w-4 h-4 rounded"
                  />
                  {l}
                </label>
              ))}
