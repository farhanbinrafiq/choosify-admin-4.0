...
<body>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-app-bg border-t border-app-border text-app-text-primary min-h-screen">
      ...
      {/* Role Notice */}
      <div className="mb-6 px-4 py-3 bg-[#18154C] border border-app-border rounded-lg flex items-center justify-between text-xs text-white/80 no-print">
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
                <div>
                  ...
                  <div className="text-base font-extrabold text-[#18154C]">{order.customer.name}</div>
                ...
                <div className="flex flex-col md:items-end">
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs text-left md:text-right">
                    ...
                    <div className="font-extrabold text-[#18154C]">#{invoiceId}</div>
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-100">
                      <td className="py-4">
                        <div className="font-bold text-[#18154C] text-sm">{order.product.name}</div>
        ...
        <div className="lg:col-span-4 space-y-6 no-print">
          ...
          <div className="p-5 bg-[#18154C]/20 border border-indigo-500/10 rounded-xl">
