...
`;
  ...
  const handlePrintInvoice = (order: Order) => {
    navigate(`/admin/invoice/${order.id}?print=true`, { state: { order } });
  };
          ...
          <SplitLayout layoutId="order-details-studio" panes={orderDetailsPanes} className="border border-app-border rounded-2xl overflow-hidden bg-app-card min-h-[600px]">
            ...
            <div className="space-y-8 p-8 h-full overflow-y-auto">
              ...
              <div className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl relative">
                <h3 className="text-xs font-black uppercase tracking-widest text-[#EF3C23] mb-6">Operations Timeline</h3>
                      ...
                      return (
                        <div key={idx} className="flex flex-row md:flex-col items-center gap-3 text-center md:text-sans">
                          <div className={`w-8 h-8 rounded-full border flex items-center justify-center font-black text-xs shrink-0 transition-all${
                            isCurrent 
                              ? 'bg-[#EF3C23] text-white border-[#EF3C23] animate-pulse scale-110 shadow-lg shadow-[#EF3C23]/30'
                              : isCompleted 
                          ...
                          <div className="text-left md:text-center mt-0 md:mt-2">
                            <div className={`text-[11px] font-black uppercase tracking-wider${isCurrent ? 'text-[#EF3C23]' : 'text-white'}`}>
                              {step.label}
                            </div>
              ...
              <div className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl space-y-6">
                <div className="flex items-center justify-between border-b border-app-border/40 pb-4">
                  <span className="text-xs font-black uppercase tracking-widest text-[#EF3C23]">Retail Cart Items</span>
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="space-y-1.5 flex-1">
                    <span className="text-[9px] font-black uppercase tracking-wider bg-app-bg border border-app-border px-2.5 py-1 rounded-full text-[#EF3C23]">
                      {order.product.brand}
                    </span>
                ...
                <div className="bg-app-bg border border-app-border rounded-2xl p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <span className="text-sm font-black text-[#EF3C23]">৳ {order.earnings.futureAutomatedDeduction.toLocaleString()}</span>
                  </div>
                  <div className="space-y-1">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-center bg-app-bg border border-app-border rounded-xl px-5 py-3.5 gap-4">
                  ...
                  >
                    <FileText className="w-3.5 h-3.5 text-[#EF3C23]" /> Invoice
                  </button>
                </div>
              </div>
              ...
              {isAdmin && (
                <div className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl space-y-6">
                  <div className="flex items-center gap-2 border-b border-app-border/40 pb-4">
                    <Truck className="w-5 h-5 text-[#EF3C23]" />
                  ...
                  {order.status === 'Returned' && (
                    <div className="bg-orange-950/40 text-orange-400 border border-orange-900/40 rounded-xl p-5 space-y-3">
                      <div className="flex items-center gap-2">
                        <AlertTriangle className="w-5 h-5 text-[#EF3C23] shrink-0" />
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#EF3C23] hover:bg-[#EF3C23]/80 text-white font-black uppercase tracking-widest text-[9px] rounded-lg transition-all shadow-md cursor-pointer flex items-center gap-1.5"
                      >
                  ...
                  <div className="space-y-4">
                    <span className="text-xs font-black uppercase tracking-widest text-[#EF3C23] block">Sellers Sub-Orders Dispatch &amp; Tracking</span>
                    {(order.subOrders || [
                      {
                        ...
                        <div className="bg-app-bg border border-app-border rounded-xl p-5 flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2.5">
                            <input 
                              ...
                              className="w-5 h-5 rounded border-app-border text-[#EF3C23] focus:ring-[#EF3C23] bg-app-card cursor-pointer accent-[#EF3C23]"
                            />
                  ...
                  <div className="space-y-3 pt-4 border-t border-app-border/40">
                    ...
                    {order.adminNotes && order.adminNotes.length > 0 && (
                      <div className="space-y-2 mt-4">
                        <span className="text-[9px] font-bold text-[#EF3C23] uppercase tracking-wider block">Admin Notes History:</span>
              ...
              {isAdmin && (
                <div className="bg-[#1e1512] border border-[#EF3C23]/20 rounded-2xl p-8 shadow-2xl space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-app-card border border-app-border rounded-xl text-xs text-app-text-primary outline-none focus:border-[#EF3C23]"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-app-card border border-[#EF3C23]/20 rounded-xl text-xs text-app-text-primary outline-none focus:border-[#EF3C23]"
                      >
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-[#EF3C23]/10">
                    {/* Suspend Order */}
                    <button 
                      onClick={() => {
            ...
            <div className="space-y-8 p-8 h-full overflow-y-auto bg-app-bg border-l border-app-border">
              ...
              {/* Customer Box */}
              <div className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl space-y-6">
                <span className="text-xs font-black uppercase tracking-widest text-[#EF3C23] block border-b border-app-border/40 pb-4">Customer profile ledger</span>
                
                <div className="flex gap-4 items-center">
                  <div className="w-12 h-12 rounded-full bg-[#EF3C23]/20 border border-[#EF3C23]/30 text-[#EF3C23] font-black text-sm flex items-center justify-center shadow-inner">
                    ...
                    <h4 className="text-sm font-black text-app-text-primary">
                      {isAdmin ? (
                        <Link 
                          ...
                          className="hover:text-[#EF3C23] hover:underline focus:outline-none focus:ring-1 focus:ring-[#EF3C23] transition-colors"
                        >
                          {order.customer.name}
                        </Link>
                      ) : (
                ...
                <div className="space-y-3 pt-3 border-t border-app-border/40 text-xs">
                  ...
                  <div className="flex justify-between items-center bg-[#EF3C23]/5 p-3 rounded-xl border border-[#EF3C23]/10">
              ...
              {/* Audit Logs Trail */}
              <div className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl space-y-6">
                <span className="text-xs font-black uppercase tracking-widest text-[#EF3C23] block border-b border-app-border/40 pb-4">Audit log activity trail</span>
                ...
                <div className="space-y-4 max-h-[220px] overflow-y-auto custom-scrollbar">
                  {auditLogs.map((log: any, idx: number) => (
                    <div key={idx} className="flex gap-3 text-[11px] items-start">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#EF3C23] mt-1 shrink-0" />
                      <div>
        ...
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 bg-[#1e1e2e]/95 border border-[#EF3C23]/40 px-6 py-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.7)] flex items-center gap-6 animate-in slide-in-from-bottom duration-300">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-app-text-primary">
              Selected <span className="text-[#EF3C23] font-black">{selectedOrders.length}</span> Batch Orders
            </span>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        <div className="space-y-1 relative z-10">
          <h1 className="text-2xl font-black text-app-text-primary tracking-tight flex items-center gap-3">
            <span className="p-2 bg-[#EF3C23]/10 border border-[#EF3C23]/20 text-[#EF3C23] rounded-xl block">
          ...
          return (
            <div className="flex flex-wrap gap-3 relative z-10">
              ...
              <div className="bg-app-bg/60 border border-app-border rounded-2xl px-5 py-3 flex flex-col justify-center min-w-[110px]">
                ...
                <span className="text-lg font-black text-[#EF3C23]">{sellerOrders.filter(o => ['Confirmed', 'Dispatched', 'In Transit'].includes(o.status)).length}</span>
              </div>
              <div className="bg-app-bg/60 border border-app-border rounded-2xl px-5 py-3 flex flex-col justify-center min-w-[110px]">
        ...
        <button
          ...
          className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3.5 text-xs font-black uppercase tracking-widest transition-all rounded-xl cursor-pointer${
            currentMainTab === 'console'
              ? 'bg-[#EF3C23] text-white shadow-lg shadow-[#EF3C23]/20'
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-transparent">
          <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto items-stretch md:items-center">
            <div className="relative w-full md:w-96 group">
              <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-[#EF3C23] transition-colors" />
              <input 
                type="text"
                placeholder="Search by ID, Customer Name, SKU, product brand, invoice..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-4 py-3 bg-app-bg border border-app-border rounded-xl text-xs text-app-text-primary placeholder-slate-500 outline-none focus:border-[#EF3C23]/60 transition-all font-medium"
              />
              {searchTerm && (
                <button 
            ...
            <button
              ...
              className={`px-4 py-3 text-xs font-black uppercase tracking-widest rounded-xl border cursor-pointer transition-all${
                codFilterOnly 
                  ? 'bg-[#EF3C23] border-[#EF3C23] text-white shadow-lg shadow-[#EF3C23]/20' 
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-app-text-secondary uppercase tracking-widest">
            <Filter className="w-3.5 h-3.5 text-[#EF3C23]" /> 12 Operations Filter Ledger 
          </div>
        </div>
        ...
        <div className="flex overflow-x-auto pb-2 gap-2 custom-scrollbar border-b border-app-border/40">
          {[
            ...
            return (
              ...
              >
                <span>{tab.label}</span>
                <span className={`text-[8.5px] font-mono px-2 py-0.5 rounded-full${isActive ? 'bg-white text-[#EF3C23] font-black' : 'bg-app-bg text-slate-500 font-bold'}`}>
                  {count}
                </span>
              </button>
            );
      ...
      {isAdmin && (
        <div className="bg-app-card border border-app-border rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-app-border/40 pb-3">
            <div className="flex items-center gap-2">
              <Filter className="w-4 h-4 text-[#EF3C23]" />
              <span className="text-xs font-black uppercase tracking-widest text-[#EF3C23]">Marketplace Advanced Cross-Check Filters (14 Criteria Checklist)</span>
            </div>
            <button 
              onClick={() => {
                setFilterSeller('All');
              ...
              className="text-[9px] font-black uppercase tracking-widest px-3 py-1 bg-app-bg border border-app-border rounded-lg text-app-text-secondary hover:text-[#EF3C23]"
            >
              Reset Filters
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select 
                ...
                className="w-full px-3 py-2 bg-app-bg border border-app-border rounded-xl text-[10px] text-app-text-primary font-medium outline-none focus:border-[#EF3C23]"
              >
          ...
          <div className="flex flex-wrap gap-1.5 items-center">
            ...
            <button
              ...
              className={`px-4.5 py-2 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all${
                activeBrandId === null 
                  ? 'bg-[#EF3C23] text-white shadow-md' 
                  : 'text-slate-400 hover:text-white hover:bg-app-bg'
              }`}
            >
              All Brands
            ...
            {allBrands.filter(b => ownedBrandIds.includes(b.id)).map(b => (
              <button
                ...
                className={`px-4.5 py-2 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all${
                  activeBrandId === b.id 
                    ? 'bg-[#EF3C23] text-white shadow-md' 
                    : 'text-slate-400 hover:text-[#EF3C23] hover:bg-app-bg'
                }`}
              >
                {b.name}
              </button>
      ...
      <div className="space-y-6 animate-in fade-in duration-300">
        {filteredOrders.length === 0 ? (
          ...
          filteredOrders.map((order) => (
                <div 
                  key={order.id} 
                  className="bg-app-card border border-app-border rounded-2xl p-8 shadow-2xl relative overflow-hidden hover:border-[#EF3C23]/30 transition-all group"
                >
                  <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-[#EF3C23] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-app-border/60">
                    <div className="flex items-center gap-4">
                      <input 
                        ...
                        className="w-4.5 h-4.5 rounded border-app-border text-[#EF3C23] focus:ring-[#EF3C23] bg-app-card cursor-pointer accent-[#EF3C23] shrink-0"
                      />
                      ...
                      >
                        ...
                        <div>
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className="font-mono text-sm font-black text-[#EF3C23] hover:underline">{order.id}</span>
                    ...
                    <Link 
                      ...
                      className="flex items-center gap-1 p-1 px-2.5 bg-app-card hover:bg-[#EF3C23]/20 text-[#6B7280] hover:text-[#EF3C23] border border-app-border rounded-lg text-[9px] font-bold transition-colors cursor-pointer shrink-0"
                      title="Quick Invoice Action"
                    >
                      <FileText className="w-3.5 h-3.5 text-[#EF3C23]" />
                      <span>Invoice</span>
                    </Link>
                  </div>
                        ...
                        <>
                          ...
                          {order.status === 'Confirmed' && (
                            <>
                              ...
                              <button 
                                ...
                                className="flex items-gradient-to-r from-[#EF3C23] to-orange-500 text-app-text-primary rounded-xl text-[10px] font-black uppercase tracking-wider shadow-lg shadow-[#EF3C23]/20 transition-all active:scale-95 cursor-pointer flex items-center gap-1.5 px-3.5 py-2.5"
                              >
                          ...
                          {order.status === 'Processing' && (
                            <>
                              <button 
                                onClick={() => openAction(order, 'dispatch')}
                                className="flex items-center gap-1.5 px-3.5 py-2.5 bg-gradient-to-r from-[#EF3C23] to-orange-500 text-white rounded-xl text-[10px] font-black uppercase tracking-wider shadow-lg shadow-[#EF3C23]/20 transition-all active:scale-95 cursor-pointer"
                              >
                                <Truck className="w-3.5 h-3.5" /> Mark Dispatched
                              </button>
                              <button 
                          ...
                          >
                            <MessageSquare className="w-3.5 h-3.5 text-[#EF3C23]" /> Comms Note
                          </button>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-[#EF3C23] font-extrabold mt-1">৳ {order.product.price.toLocaleString()}</p>
                        ...
                        <div className="bg-app-bg border border-app-border rounded-xl p-4 space-y-2">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noreferrer" 
                              className="text-[10px] font-extrabold text-[#EF3C23] hover:underline flex items-center gap-1"
                            >
                          ...
                          <div className="space-y-1">
                            {order.customerNotes.map((cn, idx) => (
                              <div key={idx} className="bg-app-bg border border-app-border rounded-xl p-3 text-[11px] text-app-text-secondary flex gap-2">
                                <span className="text-[#EF3C23] font-bold">💬</span>
                                <div>{cn}</div>
                              </div>
                            ))}
                          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-app-bg border border-app-border rounded-xl p-4 flex gap-4">
                          ...
                          <div className="space-y-0.5">
                            ...
                            <div className="text-[9px] text-[#EF3C23] font-black uppercase tracking-wider">{order.product.brand}</div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-app-border/40">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Link 
                          ...
                          className="px-3.5 py-2 bg-app-bg hover:bg-slate-700 text-[#EF3C23] border border-app-border rounded-xl text-[10px] font-black uppercase tracking-wider transition-all"
                        >
                          Invoice Details
                        </Link>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex gap-3 items-center mt-2">
                          ...
                          <div>
                            ...
                            <div className="text-[9.5px] text-[#EF3C23] font-bold mt-0.5">৳ {order.product.price.toLocaleString()}</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 md:border-x border-app-border/40 md:px-6">
                        ...
                        <div className="mt-2 text-xs">
                          {isAdmin ? (
                            <Link 
                              to={`/admin/consumers/${order.customer.id}`}
                              className="font-extrabold text-[#EF3C23] hover:underline focus:outline-none focus:ring-1 focus:ring-[#EF3C23] transition-colors block"
                            >
                              {order.customer.name}
                            </Link>
                          ) : (
              ...
              {actionType === 'note' && (
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-app-bg border border-app-border rounded-xl p-4 text-xs text-app-text-primary outline-none focus:border-[#EF3C23]/50"
                  />
                </div>
              )}
              ...
              <div className="flex gap-3 justify-end pt-2">
                ...
                <button 
                  ...
                  className={`px-6 py-3 text-[10px] font-black uppercase text-app-text-primary rounded-xl shadow-lg transition-all${
                    actionType === 'decline' ? 'bg-red-600 hover:bg-red-500' : actionType === 'cancel' ? 'bg-rose-600 hover:bg-rose-100' : actionType === 'internal' ? 'bg-amber-600 hover:bg-amber-500' : 'bg-[#EF3C23] hover:bg-orange-500'
                  }`}
                >
                  Apply Action
                </button>
