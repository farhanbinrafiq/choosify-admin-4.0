...
export default function ConsumersPage() {
  ...
  const S: Record<string, CSSProperties> = {
    ...
    empty: { color: '#9CA3AF' },
    avatar: { width: 32, height: 32, borderRadius: '50%', background: `linear-gradient(135deg, ${ACCENT}, #18154C)`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 12, fontWeight: 700, flexShrink: 0 },
