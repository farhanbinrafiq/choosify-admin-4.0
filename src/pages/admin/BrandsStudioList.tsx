                ...
                <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-app-border rounded-[18px] p-4 shadow-2xl z-[100] space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      style={{ background: 'linear-gradient(90deg,#EF3C23,#EF3C23)' }}
                    >Create</button>
                    <button
      ...
      {profile?.role === 'seller' && (
        <div className="aws-page-card p-2 flex gap-1.5 overflow-x-auto scrollbar-hide">
          <button
            ...
            style={activeSubTab === "storefronts" ? { background: 'linear-gradient(90deg,#EF3C23,#EF3C23)' } : undefined}
          >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#05050C] border border-[#202030] rounded-3xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-left">
            ...
            <div className="text-right space-y-1 bg-white/5 px-4.5 py-3 rounded-2xl border border-app-border self-stretch md:self-auto flex flex-col justify-center">
              ...
              <div className="text-sm font-bold text-[#EF3C23] flex items-center gap-1.5 justify-end">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-app-card border border-[#202030] rounded-3xl p-6 shadow-xl space-y-4 text-left">
                ...
                <div className="space-y-3.5 font-mono text-xs">
                  ...
                  <div className="p-3 bg-white/[0.01] border border-app-border rounded-xl flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-[#EF3C23] mt-1.5 shrink-0" />
                    <div className="space-y-1 flex-1">
                      <div className="flex justify-between flex-wrap gap-2">
            ...
            <div className="lg:col-span-4">
              <form onSubmit={handleSaveContactDetails} className="bg-app-card border border-[#202030] rounded-3xl p-6 shadow-xl space-y-5 text-left">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-[#EF3C23] hover:bg-orange-500 text-white font-extrabold uppercase text-[10px] tracking-widest rounded-xl transition-all shadow-md active:scale-95 cursor-pointer flex items-center justify-center gap-1.5"
                >
                ...
                <div className="bg-app-card border border-[#202030] rounded-3xl p-6 shadow-xl space-y-4 text-left">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono text-left font-sans">
                    ...
                    <div className="bg-[#05050C] border border-[#202030] p-4 rounded-2xl space-y-1">
                      ...
                      <div className="text-[#EF3C23] font-extrabold font-sans">
