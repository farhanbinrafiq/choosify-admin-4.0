    ...
    <div className="bg-[#F0F8FF] text-[#1A1A2E] overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-10 w-full -mt-2 mb-4 pb-10 space-y-4">
        ...
        <div className="bg-white rounded-xl border border-[#E8EDF2] border-t-[3px] border-t-[#2323FF] px-[26px] py-[18px] flex flex-wrap items-center justify-center gap-8 sm:gap-14 text-center">
          ...
          <div>
            <div className="text-[15px] font-extrabold text-[#EF3C23] tabular-nums">—</div>
            <div className="mt-1 bg-[#F4F7F9] text-[9.5px] font-bold px-2.5 py-0.5 rounded-[10px] inline-flex items-center gap-1 text-[#4B5563]">
        ...
        <div className="bg-white rounded-xl border border-[#E8EDF2] p-[26px] text-left relative">
          ...
          <span className="inline-block bg-[#EF3C23] text-white text-[9px] font-extrabold px-2.5 py-1 rounded-[5px] mb-3.5 uppercase tracking-wide">
            {formatKind(model)}
          </span>
          ...
          <div className="flex items-center gap-2.5 mb-5">
            {model.authorAvatar ? (
              ...
              <div className="w-[34px] h-[34px] rounded-full bg-[#EF3C23] flex items-center justify-center text-white text-xs font-extrabold shrink-0">
                {authorInitial}
              </div>
            )}
            <div>
          ...
          <div className="flex flex-wrap gap-2.5 items-center">
            <button
              type="button"
              className="inline-flex items-center gap-1.5 bg-[linear-gradient(90deg,#6C4CFF,#EF3C23)] text-white border-0 px-[18px] py-[11px] rounded-lg text-xs font-bold"
            >
        ...
        <section className="choosify-dark-surface rounded-xl px-7 py-6 text-white text-center">
          ...
          <button
            type="button"
            className="inline-flex items-center gap-1.5 bg-[#EF3C23] text-white border-0 px-5 py-2.5 rounded-lg text-xs font-bold"
          >
            Support Creator
          </button>
        </section>
