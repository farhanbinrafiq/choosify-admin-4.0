                  ...
                  <tr key={o.id} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <Link
                        ...
                        className="font-bold text-[#EF3C23] hover:underline"
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 border border-slate-200 hover:bg-[#EF3C23]/10 hover:border-[#EF3C23]/20 text-[#EF3C23] rounded-lg transition-all text-[10px]"
                      >
