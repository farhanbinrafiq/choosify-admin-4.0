    ...
    <div className="space-y-6" id="account_information_panel">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-medium">
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 focus:outline-none focus:border-[#EF3C23] font-medium" 
            />
          </div>
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 focus:outline-none focus:border-[#EF3C23] font-mono" 
            />
          </div>
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 focus:outline-none focus:border-[#EF3C23]" 
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5 md:col-span-2">
            ...
            <textarea 
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 focus:outline-none focus:border-[#EF3C23] font-medium resize-none" 
            />
          </div>
        </div>
          ...
          {[
            ...
            <label key={item.key} className="flex items-start gap-3 bg-slate-50 p-4 border border-slate-205 rounded-xl cursor-pointer hover:bg-slate-100/50 transition-all select-none">
              <input 
                ...
                className="mt-0.5 accent-[#EF3C23]" 
              />
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-5 text-left">
        <div className="flex items-center gap-2">
          <Lock className="w-4 h-4 text-[#EF3C23]" />
        ...
        <div className="flex justify-end pt-2">
          <button 
            ...
            className="px-6 py-2.5 bg-[#EF3C23] hover:bg-[#EF3C23] text-white rounded-xl text-xs font-black uppercase tracking-wider shadow-sm transition-all"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1">
                ...
                <PasswordInput
                  ...
                  wrapperClassName="flex items-center gap-2 w-full bg-white border border-slate-300 rounded-xl px-4 focus-within:border-[#EF3C23]"
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 text-left">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-slate-50/50 border border-slate-205 rounded-xl p-4 space-y-3">
            <span className="text-[10px] font-black tracking-widest text-[#EF3C23] uppercase block">Record New Audit Event</span>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
              <input 
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2 focus:outline-none focus:border-[#EF3C23] font-bold"
              />
              <input 
                type="text" 
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2 focus:outline-none focus:border-[#EF3C23] font-medium"
              />
            </div>
            <div className="flex justify-end">
              <button 
