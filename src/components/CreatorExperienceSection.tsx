            ...
            <div className="md:col-span-2 relative aspect-video md:aspect-[4/3] rounded-xl overflow-hidden bg-slate-100 border border-slate-200 group">
              ...
              <div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-all flex items-center justify-center">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-[#EF3C23] text-white flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform active:scale-95 cursor-pointer border-none"
                >
              ...
              <span className="absolute bottom-2.5 right-2.5 bg-slate-900/90 text-[8px] font-mono font-bold text-white px-2 py-0.5 rounded-md">
            ...
            >
              ...
              <div className="relative aspect-video rounded-lg overflow-hidden bg-slate-100 border border-slate-200 mb-2.5">
                ...
                <button
                  ...
                  className="absolute inset-0 bg-black/10 group-hover/card:bg-black/35 transition-all flex items-center justify-center cursor-pointer border-0"
                >
                  <div className="w-8 h-8 rounded-full bg-[#EF3C23] text-white flex items-center justify-center shadow-md transform group-hover/card:scale-110 transition-transform">
                ...
                <span className="absolute bottom-1.5 right-1.5 bg-slate-900/90 px-1.5 py-0.5 rounded text-[8px] font-mono text-white leading-none">
                  {item.duration}
                </span>
              </div>
      ...
      {onAddReviewClick && (
        <div className="mt-6 flex justify-center relative z-10">
          <button
            ...
            className="w-full py-3 bg-[#EF3C23] hover:bg-[#eb2b10] text-white hover:text-white text-xs font-black uppercase tracking-widest rounded-xl transition duration-200 flex items-center justify-center gap-2 shadow-sm cursor-pointer border-none"
          >
          ...
          <div className="bg-white border border-slate-300 rounded-3xl overflow-hidden w-full max-w-2xl relative z-10 shadow-2xl p-5 space-y-4 text-left">
            <div className="flex justify-between items-center pb-2 border-b border-slate-200">
              ...
              <button 
                ...
                className="text-slate-400 hover:text-slate-700 text-xs font-black font-mono px-2 py-1 hover:bg-slate-100 rounded-lg transition-all"
              >
                ✕ CLOSE
              </button>
            </div>
            ...
            <div className="p-4 bg-[#f8f9fb] border border-slate-200 rounded-2xl text-center space-y-3.5 text-xs text-[#1a1a2e]">
              ...
              <div className="flex gap-2 justify-center pt-2">
                <button 
                  ...
                  className="px-4 py-2 bg-[#EF3C23] hover:bg-red-650 text-white rounded-xl text-[10px] font-black uppercase tracking-wider transition-colors"
                >
                  Copy Link
                </button>
                <a 
