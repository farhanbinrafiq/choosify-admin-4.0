              ...
              <div className="pt-2 border-t border-[#F1F1F3] relative">
                {mode === 'editor' && onEditSection ? (
                  <button
                    ...
                    className="absolute top-2 right-0 text-[10px] font-extrabold text-[#FF5B00] uppercase bg-transparent border-0 cursor-pointer"
                  >
                    Edit
                  </button>
                ) : null}
                ...
                {model.creatorVideos.map((c) => (
                  <div key={c.id} className="bg-white border border-[#E8EDF2] rounded-[10px] overflow-hidden">
                    ...
                    <div className="p-3 text-left">
                      <div className="text-[10px] font-extrabold text-[#FF5B00] uppercase">{c.platform}</div>
