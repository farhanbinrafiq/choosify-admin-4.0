      ...
      >
        <div className="flex items-center gap-3">
          {selected?.logo ? (
            ...
            <div className="w-6 h-6 bg-[#EF3C23]/20 text-[#EF3C23] rounded flex items-center justify-center text-xs font-bold">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isCurrent && <Check size={16} className="text-[#EF3C23] ml-2" />}
                  </div>
                </button>
              );
            })
