...
export const PickupAddressSelector: React.FC<PickupAddressSelectorProps> = ({
  ...
  return (
    <div className="border border-app-border rounded-xl p-4 bg-slate-950/50">
      <div className="flex items-start gap-3">
        <MapPin size={18} className="text-[#F4631E] mt-0.5 flex-shrink-0" />
        <div className="text-xs text-slate-300">
          <div className="font-bold text-white mb-0.5">{address.street || 'Default Pickup Warehouse'}</div>
