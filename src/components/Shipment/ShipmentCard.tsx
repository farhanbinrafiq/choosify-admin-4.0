...
export const ShipmentCard: React.FC<ShipmentCardProps> = ({
  ...
  const getStatusBadgeStyle = (status: string) => {
    ...
    return 'bg-[#EF3C23]/10 text-[#EF3C23] border border-[#EF3C23]/20';
  };
  ...
  return (
    <div className="bg-app-card border border-app-border rounded-[2rem] overflow-hidden shadow-2xl text-app-text-primary">
      ...
      <div className="bg-app-bg px-8 py-5 flex items-center justify-between border-b border-app-border">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-[#EF3C23]/15 rounded-xl border border-[#EF3C23]/20">
            <Truck size={20} className="text-[#EF3C23]" />
          </div>
          <div>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="border border-app-border rounded-2xl overflow-hidden bg-app-bg/10">
          ...
          >
            <div className="flex items-center gap-3">
              <Package size={18} className="text-[#EF3C23]" />
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-app-bg p-4 border border-app-border rounded-xl">
                          ...
                          <div className="text-xs font-black text-emerald-600 font-mono tracking-wider flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-[9px] text-app-text-secondary hover:text-[#EF3C23] underline font-sans cursor-pointer font-bold"
                            >
                              Copy
                            </button>
                          </div>
                      ...
                      <div className="pt-4 border-t border-app-border/40 grid grid-cols-1 sm:grid-cols-4 gap-3">
                        ...
                        <button
                          ...
                          className="px-3 py-2.5 bg-[#EF3C23]/10 hover:bg-[#EF3C23]/20 text-[#EF3C23] rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all cursor-pointer border border-[#EF3C23]/20 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <Truck size={12} />
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          {recommendedCourier && (
                            <span className="text-[9px] font-black text-[#EF3C23] bg-[#EF3C23]/10 border border-[#EF3C23]/20 px-2.5 py-0.5 rounded-full uppercase tracking-widest animate-pulse">
                        ...
                        <div className="bg-app-bg border border-app-border rounded-xl p-4 space-y-3">
                          ...
                          {estimateLoading ? (
                            <div className="flex items-center gap-2 text-xs text-app-text-secondary font-medium">
                              <RefreshCw size={12} className="animate-spin text-[#EF3C23]" />
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                              ...
                              <div>
                                ...
                                <span className="text-xs font-black text-[#EF3C23]">৳ {shippingEstimate.totalCharge}</span>
                              </div>
                              <div>
                      ...
                      <div className="bg-app-bg border border-app-border rounded-xl px-5 py-3.5 flex items-center justify-between">
                        <div className="flex items-center gap-2 text-xs font-semibold text-app-text-secondary">
                          <Package size={14} className="text-[#EF3C23]" />
                      ...
                      <button
                        ...
                        className="w-full py-4.5 bg-[#EF3C23] hover:bg-[#EF3C23]/90 disabled:bg-app-bg disabled:text-app-text-secondary/50 text-white font-black uppercase tracking-widest rounded-xl transition-all shadow-xl shadow-[#EF3C23]/10 flex items-center justify-center gap-2 cursor-pointer active:scale-98"
                      >
                        <Plus size={16} />
