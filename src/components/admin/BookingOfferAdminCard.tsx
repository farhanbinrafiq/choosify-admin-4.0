...
export function BookingOfferAdminCard({ offer, sellerId, sellerName, onUpdated }: Props) {
  ...
  return (
    <div className="mt-2 rounded-2xl border border-[#E8EDF2] bg-white p-3.5 text-left shadow-sm space-y-3 max-w-md">
      ...
      <div className="text-[15px] font-black text-[#EF3C23]">
      ...
      {canAct && (
        <div className="flex flex-wrap gap-2 pt-1">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-[#FFF3EA] text-[#EF3C23] border border-[#EF3C23]/20 text-[11px] font-extrabold uppercase tracking-wide disabled:opacity-50"
          >
            Modify & Resend
          </button>
        </div>
      ...
      {showDecline && (
        <div className="space-y-2 border-t border-[#E8EDF2] pt-3">
          ...
          <textarea
            ...
            rows={2}
            className="w-full rounded-xl border border-[#E8EDF2] px-3 py-2 text-[12px] outline-none focus:border-[#EF3C23]"
      ...
      {showCounter && (
        <div className="space-y-2 border-t border-[#E8EDF2] pt-3">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#E8EDF2] px-3 py-2 text-[12px] outline-none focus:border-[#EF3C23] font-mono font-bold"
          />
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-[#EF3C23] text-white text-[11px] font-extrabold uppercase tracking-wide disabled:opacity-50"
          >
            Send counter-offer
          </button>
        </div>
